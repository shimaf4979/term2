...
public class OldPlayer extends ap25.Player {
  static final String MY_NAME = "Old";
  OldMyEval eval;
  int depthLimit;
  Move move;
  MyBoard board;

  public OldPlayer(Color color) {
    this(MY_NAME, color, new OldMyEval(), 3);
  }

  public OldPlayer(String name, Color color, OldMyEval eval, int depthLimit) {
    super(name, color);
    this.eval = eval;
  ...
  public OldPlayer(String name, Color color, int depthLimit) {
    this(name, color, new OldMyEval(), depthLimit);
  }
